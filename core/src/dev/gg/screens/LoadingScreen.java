...
public class LoadingScreen extends BaseScreen {
	...
	@Asset(Texture.class)
	private static final String LOGO_TEXTURE_PATH = "badlogic.jpg";
	@Asset(Texture.class)
	...
	public final AssetDescriptor<BitmapFont> MAIN_FONT_19_PATH() {
		...
		return new AssetDescriptor<BitmapFont>(
				"mainFont19.ttf", BitmapFont.class,
				font);
	}
	...
	public final AssetDescriptor<BitmapFont> MAIN_FONT_22_PATH() {
		...
		return new AssetDescriptor<BitmapFont>(
				"mainFont22.ttf", BitmapFont.class,
				font);
	}
	...
	public final AssetDescriptor<BitmapFont> HANDWRITTEN_FONT_20_PATH() {
		...
		font.fontParameters.size = 20;
		return new AssetDescriptor<BitmapFont>(
				"handwrittenFont20.ttf", BitmapFont.class, font);
	}
	...
	protected void onInit() {
		...
		logoTexture = assetManager.get(LOGO_TEXTURE_PATH);
		...
		// TODO assetManager.load(game.getScreen("map"));
	}
	...
	private void onFinishedLoading() {
		...
		// TODO notify screens whose assets got loaded
