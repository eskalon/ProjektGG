 ...
 * the {@link #mainTable}.
 */
public abstract class BaseUIScreen extends BaseScreen<ProjektGG> {
	...
	public void show() {
		...
		mainTable.setDebug(game.isInDebugMode());
	...
	protected float getUIVolumeLevel() {
		return (float) MathUtils
				.linToExp(game.getSettings().getFloat("effectVolume", 1F)
						* game.getSettings().getFloat("masterVolume", 1F), 2);
	}
}
