...
import de.gg.game.types.BuildingType.BuildingTypeData;
import de.gg.game.types.CartType.CartTypeData;
import de.gg.game.types.CrimeType.CrimeTypeData;
import de.gg.game.types.GameMap.GameMapData;
import de.gg.game.types.ItemType.ItemTypeData;
import de.gg.game.types.LawType.LawTypeData;
import de.gg.game.types.NPCCharacterTrait.NPCCharacterTraitData;
import de.gg.game.types.PlayerTaskType.PlayerTaskTypeData;
import de.gg.game.types.PositionType.PositionTypeData;
import de.gg.game.types.ProfessionType.ProfessionTypeData;
import de.gg.game.types.SocialStatus.SocialStatusData;
...
public class TypeRegistry {
	...
	public void initialize(AssetManager assetManager) {
		...
		for (PositionType t : PositionType.values()) {
			...
			if (t.getData().hasLawsToVoteFor()) {
				for (Integer i : t.getData().getIndicesOfLawsToVoteFor()) {
					LawType.values()[i].getData().getVoters().add(t);
				}
			}
		}
