...
public class CharacterFactory {
	...
	@InjectAsset(value = "data/misc/surnames.json", params = "array_list_string")
	private static JSON SURNAMES_ASSET;
	@InjectAsset(value = "data/misc/male_names.json", params = "array_list_string")
	private static JSON MALE_NAMES_ASSET;
	@InjectAsset(value = "data/misc/female_names.json", params = "array_list_string")
